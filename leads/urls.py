...
from .views import ContactCreateView, ResumeLeadCreateView, ResumeDownloadView, ResumeFileDownloadView, SubscriberCreateView
...
urlpatterns = [
    ...
    path("add/subscriber/", SubscriberCreateView.as_view())
]